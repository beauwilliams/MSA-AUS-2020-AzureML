...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.parse = function (tokens, renderer) {
        ...
        this.inline = new marked_1.InlineLexer(tokens.links);
        ...
        switch (this.token.type) {
            ...
            case 'table': {
                var header = this.token.header.map(function (cell, i) {
                    return renderer.create(_this.options.TableHeaderCell, { align: _this.token.align[i] },
                        renderer.create("span", { _innerHTML: _this.inline.output(cell) }));
                });
                var body = this.token.cells.map(function (row) {
                    return renderer.create(_this.options.TableRow, null, row.map(function (cell, j) { return renderer.create(_this.options.TableCell, { align: _this.token.align[j] },
                        renderer.create("span", { _innerHTML: _this.inline.output(cell) })); }));
                });
